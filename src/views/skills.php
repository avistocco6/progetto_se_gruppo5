...
<html>
    <head>
        ...
        <!-- The system must allow a System Administrator to view a list of competences related to a specific task. -->
    	<meta charset="utf-8"/>
    ...
    <body>
        ...
        <div class="column" style="text-align: center;">
            <table id="skills">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center;"><h3>Skills</h3></th>
                        <th style="text-align: center;"><h3>Edit</h3></th>
                        <th style="text-align: center;"><h3>Delete</h3></th>
                    </tr>
                    <template id="skills-row-template">
                        <tr>
                            <td>{ID}</td>
                            <td>{Skill}</td>
                            <td style="text-align:center;">
                                <a href="updateskill.php" onclick="passId();" class="btn btn-success btn-lg">
                                    <span class="glyphicon glyphicon-edit"></span>  
                                </a>
                            </td>
                            <td style="text-align:center;">
                                <a href="removeskill.php" onclick="passId();" class="btn btn-success btn-lg">
                                    <span class="glyphicon glyphicon-edit"></span>
                                </a>
                            </td>
                        </tr>
            ...
            <br>
            <a href="addskill.php" class="btn btn-info btn-lg">
    ...
    <script type="application/javascript">
      ...
      function passId() {
          $('#skills-rows').find('tr').click( function(){
