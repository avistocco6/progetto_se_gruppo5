...
<head>
 ...
 <!--The system must allow to create maintenance typologies as Electrical, electronic, hydraulic, mechanical. -->
...
<body>
  ...
  <div class="column" style="text-align: center;">
    <fieldset>
      <legend><h2>Add typology</h2></legend>
      <p>
      ...
      <p>
        <button onclick="addTypology()">Save</button>
      </p>
    </fieldset>
  </form>  
  <div class="pag">
