...
<head>
 ...
 <!-- The system must allow a System Administrator to delete a list of competences related to a specific task. -->
 <meta charset="utf-8"/>
...
<body>
  ...
  <div class="column" style="text-align: center;">
    <fieldset>
      <legend><h2>Remove skill</h2></legend>
      <p>
        Are you sure you want to delete this skill?
      </p>
      <p>
        <button onclick="removeSkill()">Delete</button>
      </p>
      <p>
        <button><a href="skills.php">Return</a></button>
      </p>
