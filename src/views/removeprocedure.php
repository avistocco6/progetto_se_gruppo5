...
<head>
 <title> Remove Procedure</title>
 <!--The system must allow to delete a list of Maintenance procedures. -->
 <meta charset="utf-8"/>
...
<body>
  ...
  <div class="column" style="text-align: center;">
    <fieldset>
      <legend><h2>Remove procedure</h2></legend>
      <p>
        Are you sure you want to delete this procedure?
      </p>
      <p>
        <button onclick="removeProcedure()">Delete</button>
      </p>
      <p>
        <button><a href="procedures.php">Return</a></button>
      </p>
    </fieldset>
  </div>
  <div class="footer">
