...
insert into Client(username,pass,clientname,clientrole, email)
values('simonasorgente','s1m0n4','Simona Sorgente','planner', 'sim@gmail.com');
insert into Client(username,pass,clientname,clientrole, email)
values('antoniettanapoli','4n70n1e774','Antonietta Napoli','planner', 'ant@gmail.com');
insert into Client(username,pass,clientname, clientrole, email)
values('antonellarossi','4n70nell4','Antonella Rossi','planner', 'a.r@gmail.com');
insert into Client(username,pass,clientname, clientrole, email)
values('angelovistocco','4ngel0','Angelo Vistocco','planner', 'a.v@gmail.com');
...
insert into Client(username,pass,clientname,clientrole, email)
values('SysAdmin1','sysadmin','Administrator','system administrator', 'systemadministrator1@gmail.com');
insert into Client(username,pass,clientname,clientrole, email)
values('ProManager','proman','Manager','production manager', 'productionmanager@gmail.com');
--------------------------------INSERT INTO SKILL
...
values ('unscrew the affected part; remove the cables; remove the residues; apply new cables.',001);
insert into MainProcedure(description, idactivity)
